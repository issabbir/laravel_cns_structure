                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 {{ $errors->has('address') ? 'has-error' : ''}}">
                                    <input type="text" class="form-control"  id="address" name="address" value="{{old('address', $store->nbr_regi_no)}}" placeholder="Enter Address" autocomplete="off" maxlength="255">
